...
echo '<div id="j-main-container" class="span10">'
	...
	.'</div>';
	echo '<div class="ph-cpanel-logo">'.JHtml::_('image', 'media/com_phocapdf/images/administrator/logo-phoca-pdf.png', 'Phoca.cz') . '</div>';
	echo '<h3>'.JText::_($this->t['l'].'_PHOCA_PDF').' - '. JText::_($this->t['l'].'_INFORMATION').'</h3>'
