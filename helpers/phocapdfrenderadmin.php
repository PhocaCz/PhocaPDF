...
class PhocaPdfRenderAdmin
{
	...
	public static function getLinks() {
		...
		switch ($option) {
			...
			case 'com_pdf':
				$links[]	= array('Phoca PDF site', 'https://www.phoca.cz/phocapdf');
				$links[]	= array('Phoca PDF documentation site', 'https://www.phoca.cz/documentation/category/47-phoca-pdf-component');
				$links[]	= array('Phoca PDF download site', 'https://www.phoca.cz/download/category/79-phocapdf');
			break;
